...
public class auto_engg_sem4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_auto_engg_sem4);

        RecyclerView autosem4rc=findViewById(R.id.auto_engg_sem4);
        ...
        autosem4rc.setLayoutManager(new LinearLayoutManager(this));
        autosem4rc.setAdapter(new MyAdapter(getApplicationContext(),items));
    }
}