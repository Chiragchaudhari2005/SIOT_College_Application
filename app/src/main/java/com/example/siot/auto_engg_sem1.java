...
public class auto_engg_sem1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_auto_engg_sem1);

        RecyclerView autosem1rc=findViewById(R.id.auto_engg_sem1);
        ...
        autosem1rc.setLayoutManager(new LinearLayoutManager(this));
        autosem1rc.setAdapter(new MyAdapter(getApplicationContext(),items));
    }
}